...
主题驱动的多源视频自动编排系统
输入：一个主题关键词（如 “滑雪”、“智能手机”、“宠物陪伴”）+ 一个视频集
输出：一个主题连贯、风格一致、可观看的短视频。
系统自动从海量长短不一的原始视频中，检索、筛选、剪辑、编排并输出最终视频。

###  北极星目标

**输入**：主题关键词（例：场景1“沙滩”，场景2“智能手机”）+ 一个视频集（例：场景1视频集1，场景2视频集2）
...
---
**实施进度同步**：每次阶段实现都需在 `docs/PROGRESS.md` 中登记当前状态及产出，便于贡献者对照本文件的北极星目标快速识别缺口。*** End Patch
